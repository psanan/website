...
Institute of  Geophysics\\ Sonneggstrasse 5\\ ETH Zurich, NO H 23\\ 8092 Zurich, Switzerland
\end{minipage}
\begin{minipage}{0.5\textwidth}
\href{mailto:patrick.sanan@gmail.com}{patrick.sanan@gmail.com} \\
\href{https://patricksanan.com}{patricksanan.com}\\
+41 44 632 02 44 (office)\\
+41 77 485 17 96 (mobile)\\
\end{minipage}
...
\textbf{Very experienced}: C, C++, Python, Fortran, Git, \LaTeX, Unix shell scripting, OS X, MPI, MATLAB, Mathematica
\textbf{Significant exposure}: HPC systems, CUDA, OpenMP, Julia
...
Geophysical Fluid Dynamics Group, Institute of Geophysics, Department of Earth Sciences, ETH Zurich \\
PI: Paul J. Tackley \\
\begin{innerlist}
\item
\item
...
\href{https://caltech.edu}{California Institute of Technology}
\hfill {2013}
...
\href{https://ucsd.edu}{University of California, San Diego (UCSD)}
\hfill {2006}
Minor: Music \\
