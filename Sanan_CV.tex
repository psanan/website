...
\href{https://patricksanan.com}{patricksanan.com}\\
...
Applied mathematician, computational scientist, and software developer. Scientific software, scalable algorithms, high performance computing, linear algebra, numerical PDEs, computational geometry, computational earth science, sound and music generation.


\vspace{0.2cm}

\section{Technical Skills}
\textbf{Very experienced}: C, C++, Python, Fortran, Git, \LaTeX, Unix shell scripting, MPI, MATLAB, Mathematica\\
\textbf{Significant exposure}: CUDA, Cray systems, OpenMP, Julia
...
PI: Andreas Fichtner \\
% 1-month interstitial appointment, performing initial investigations into accelerating use of \PETc{}'s \texttt{DMPlex} within \textsc{SALVUS}.
...
\begin{outerlist}
    %\item ``\textsc{StagBL}: A Scalable, Portable, High-Performance Discretization and Solver Layer for Geodynamic Simulation'', with Paul J. Tackley, PASC Review, January 15, Universit\`{a} della Svizzera italiana, Lugano, Switzerland
...
\begin{lonelist}
\item\bibentry{BolraoEtAl2020}  % preprint
\item\bibentry{SananMayBollhoeferSchenk2020}  % preprint
\item\bibentry{MorganSananKnepleyMills2020}  % As of 2020.06, to appear
...
\item\bibentry{Sanan2014}  % Include link to goofy video from UCSD?
