...
Applied mathematician, computational scientist, and software developer, with expertise in scientific software, scalable algorithms, high performance computing, linear algebra, numerical PDEs, computational geometry, computational earth science, sound and music generation.

\vspace{0.2cm}

\section{Technical Skills}
\dimmed{very experienced:} C, C++, Python, Git, \LaTeX, shell scripting, MPI, MATLAB \\
...
ETH Zurich
\hfill {October 2017}\\
\textsc{SALVUS} PASC Co-Design Project\\
...
\textbf{Additional Short Tutorials}\\
See \href{https://patricksanan.com/pages/teaching.html}{patricksanan.com}.
