...
\item ``Extreme-scale Multigrid Components within PETSc'', PETSc Users Meeting, Vienna, Austria, June 28-30, 2016.
\item ``Extreme-scale Multigrid Components within PETSc'', ACM/PASC16 conference, Lausanne, Switzerland, June 8-10, 2016.[\href{http://insidehpc.com/2016/06/extreme-scale-multigrid/}{video online}]
...
\item ``Co-designing algorithms: Pipelined, Flexible Krylov Subspace Methods and  Accelerated Subdomain Solves'',  SeisMIC, Technical University of Ostrava, Czech Republic, February 5, 2016.
\item ``Co-designing algorithms: Pipelined, Flexible Krylov Subspace Methods and  Accelerated Subdomain Solves'', Computing Sciences Seminar, Lawrence Berkeley Lab, January 12, 2016.
