...
PI: Paul J. Tackley \\
\begin{tightitemize}
\item Led development on \textsc{StagBL}, \texttt{DMStag} within \textsc{PETSc}, and \textsc{SciATH}
...
\begin{tightitemize}
\item Researched and implement large-scale, parallel, communication-avoiding and GPU-accelerated operators and multigrid smoothers for large-scale Stokes flow.
\end{tightitemize}
...
% Description:
\begin{tightitemize}
\item CAD design and analysis for synthetic aperture radar.
\end{tightitemize}
