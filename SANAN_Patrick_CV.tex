...
\begin{itemize}
% GeoPC wrapup paper on pTatin/GPU?
% Practical ILDL paper to be submitted soon
% SC ILDL paper needs to be resubmitted
...
% to include
\begin{itemize}
  \item ``GeoPC: Composable Solvers for Geophysics on Modern Architectures'', PASC 17 Conference, Lugano, Switzerland, June 26-28, Lugano.
