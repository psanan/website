...
{\Large Patrick Sanan}\\
{\tt \href{mailto:patrick.sanan@gmail.com}{patrick.sanan@gmail.com}},\quad{\tt \href{mailto:patrick.sanan@usi.ch}{patrick.sanan@usi.ch}}\\
...
\begin{itemize}
% submitted Donfack Vanroose et al PASC
% submitted PCTELESCOPE PASC
% submitted Morgan/Knepley
\item Patrick Sanan, Sascha M. Schnepp, Dave A. May, ``Pipelined, Flexible Krylov Subspace Methods'' [submitted to SISC] \href{http://arxiv.org/abs/1511.07226}{[preprint online]}.
...
\item ``Pipelined, Flexible Krylov Subspace Methods and Accelerated Subdomain Smoothing: Attacks on aggrkssive nested preconditioners for challenging geophysical Stokes flow problems''[minisymposium talk], SIAM Conference on Applied Linear Algebra, Atlanta, Georgia, USA, October 26-30, 2015.
