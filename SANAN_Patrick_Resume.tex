...
\begin{itemize}
% Something at PETSc users' meeting?
% Submitted SC ILDL paper (expected to be rejected)
% EGU Talk
\item Patrick Sanan, Olaf Schenk, Dave May, Matthias Bollh\"{o}ffer, Karl Rupp, ``Advancing Parallel Multigrid Solvers for Highly Heterogeneous Viscosity Stokes Flow Structure through Localized Incomplete $LDL^T$ Smoothers'' [poster], SIAM Conference on Parallell Procssing 2016, April 12-15, Paris, France.
\item Dave May, Matthew G. Knepley, Barry Smith, Karl Rupp, and Patrick Sanan, ``Extreme-scale Multigrid Components within PETSc'', Proceedings of the 2016 ACM/PASC16 Conference [accepted].
\item Patrick Sanan, Sascha M. Schnepp, Dave A. May, ``Pipelined, Flexible Krylov Subspace Methods'' [in revision for SISC] \href{http://arxiv.org/abs/1511.07226}{[preprint online]}.
...
\item Patrick Sanan, ``Geometric Elasticity for Graphics, Simulation, and Computation'' [thesis], 2013 \href{http://resolver.caltech.edu/CaltechTHESIS:12052013-121547860}{[text online]}
...
\item Isaac Chao, Ulrich Pinkall, Patrick Sanan, and Peter Schr\"{o}der, ``A Simple Geometric Model For Elastic Deformation'', ACM Transactions on Graphics (TOG) {\href{http://multires.caltech.edu/pubs/GeomElastic.pdf}{[text online]}}\\
...
\item ``Using Julia on a Cray Supercomputer''[lightning talk], Juliacon 2015, MIT, Boston, Massachusetts, USA, June 24-27, 2015. % Add video here!
\end{itemize}
