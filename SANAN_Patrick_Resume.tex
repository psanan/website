...
\begin{itemize}
\item ``Robust Multigrid Solvers for Geodynamics''
  \begin{itemize}
    \item German-Swiss Geodynamics Workshop, Lichtenfels, Germany, September 11-14, 2016.
  %  \item Swiss Geoscience Meeting, Geneva Switzerland, ... [ if accepted]
  \end{itemize}
