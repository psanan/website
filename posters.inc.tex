\begin{itemize}
    % StagBL : SIAMPP
  \item ``\textsc{StagBL}: A scalable, portable, high-performance discretization and solver layer for geodynamic simulation'', Swiss Geocomputing Center Kickoff Meeting, Lausanne, Switzerland, October 15-17, 2018.
  \item ``\textsc{StagBL}: A scalable, portable, high-performance discretization and solver layer for geodynamic simulation'', GeoMod 2018, Barcelona, Spain, October 1-4, 2018.
  \item ``\textsc{StagBL}: A scalable, portable, high-performance discretization and solver layer for geodynamic simulation'', PASC 18, Basel, Switzerland, July 2-4, 2018.
  \item ``\textsc{StagBL}: A Parallel Solver and Discretization Library for Geodynamic Simulation on Staggered Grids'', EGU General Assembly, Vienna, Austria, April 23-28, 2018.
